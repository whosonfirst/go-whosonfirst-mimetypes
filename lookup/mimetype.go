...
// This file was generated by robots on 2018-01-22T01:37:14Z
...
var ByMIMETYPE = map[string][]string{
	...
	"application/octet-stream	bin": []string{"dms", "lrf", "mar", "so", "dist", "distz", "pkg", "bpk", "dump", "elc", "deploy"},
	...
	"application/vnd.adobe.air-application-installer-package+zip	air": []string{},
	...
	"application/vnd.anser-web-certificate-issue-initiation	cii": []string{},
	"application/vnd.anser-web-funds-transfer-initiation	fti": []string{},
	...
	"application/vnd.cluetrust.cartomobile-config-pkg	c11amz": []string{},
	...
	"application/vnd.fujixerox.docuworks.binder	xbd": []string{},
	...
	"application/vnd.handheld-entertainment+xml	zmm": []string{},
	...
	"application/vnd.llamagraphics.life-balance.desktop	lbd": []string{},
	"application/vnd.llamagraphics.life-balance.exchange+xml	lbe": []string{},
	...
	"application/vnd.ms-excel.sheet.binary.macroenabled.12	xlsb": []string{},
	"application/vnd.ms-excel.sheet.macroenabled.12": []string{"xlsm"},
	"application/vnd.ms-excel.template.macroenabled.12	xltm": []string{},
	...
	"application/vnd.ms-powerpoint.presentation.macroenabled.12	pptm": []string{},
	...
	"application/vnd.ms-word.document.macroenabled.12	docm": []string{},
	"application/vnd.ms-word.template.macroenabled.12	dotm": []string{},
	...
	"application/vnd.nokia.n-gage.symbian.install	n-gage": []string{},
	...
	"application/vnd.oasis.opendocument.chart-template	otc": []string{},
	"application/vnd.oasis.opendocument.database": []string{"odb"},
	"application/vnd.oasis.opendocument.formula":  []string{"odf"},
	"application/vnd.oasis.opendocument.formula-template	odft": []string{},
	"application/vnd.oasis.opendocument.graphics": []string{"odg"},
	"application/vnd.oasis.opendocument.graphics-template	otg": []string{},
	"application/vnd.oasis.opendocument.image": []string{"odi"},
	"application/vnd.oasis.opendocument.image-template	oti": []string{},
	"application/vnd.oasis.opendocument.presentation": []string{"odp"},
	"application/vnd.oasis.opendocument.presentation-template	otp": []string{},
	"application/vnd.oasis.opendocument.spreadsheet": []string{"ods"},
	"application/vnd.oasis.opendocument.spreadsheet-template	ots": []string{},
	"application/vnd.oasis.opendocument.text":        []string{"odt"},
	"application/vnd.oasis.opendocument.text-master": []string{"odm"},
	"application/vnd.oasis.opendocument.text-template	ott": []string{},
	...
	"application/vnd.openxmlformats-officedocument.presentationml.presentation	pptx": []string{},
	"application/vnd.openxmlformats-officedocument.presentationml.slide	sldx": []string{},
	"application/vnd.openxmlformats-officedocument.presentationml.slideshow	ppsx": []string{},
	"application/vnd.openxmlformats-officedocument.presentationml.template	potx": []string{},
	"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet	xlsx": []string{},
	"application/vnd.openxmlformats-officedocument.spreadsheetml.template	xltx": []string{},
	"application/vnd.openxmlformats-officedocument.wordprocessingml.document	docx": []string{},
	"application/vnd.openxmlformats-officedocument.wordprocessingml.template	dotx": []string{},
	...
	"application/vnd.shana.informed.formtemplate	itp": []string{},
	"application/vnd.shana.informed.interchange	iif": []string{},
	...
	"application/vnd.stardivision.writer-global	sgl": []string{},
	...
	"application/vnd.sun.xml.impress.template	sti": []string{},
	...
	"application/vnd.tao.intent-module-archive	tao": []string{},
	...
	"application/vnd.yamaha.openscoreformat.osfpvg+xml	osfpvg": []string{},
